...
/** 多语言文案：后端模板字段统一反序列化为该形状（未提供的语言为 null） */
...
export interface AttachmentDef {
  ...
  name: LocalizedText        // 显示名：大纲 / 世界观 / 人设（支持多语言）
  contextLabel: LocalizedText // 进 AI 上下文的包装标签：文章大纲 / 世界观设定
  /**
...
export interface AppSettings {
  ...
  model: string
  style: string
  /** 是否查询/展示 AI 思考过程（cot）。关闭后服务端丢弃 reasoning_content，不发送不存储 */
