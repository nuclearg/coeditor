...
export default {
  ...
  'settings.dataDirHint': '所有数据（文章、章节、草稿、AI 会话）都保存在这个目录下。切换后需重启生效，原目录的数据不会被移动。',
  ...
  'settings.dataDirPersistHint': '需要重启后生效',
  ...
  'home.importTextPlaceholder': '将文本粘贴到此处，AI 将自动拆分章节，并把每章正文切成约 1000 字的段落（上限 10 万字）',
  'home.importPrereq': '请先选择模板并填写标题，再导入',
  'home.allWorks': '全部作品',
  ...
  'apiConfig.provider': '模型提供商',
  'apiConfig.providerCustom': '自定义（OpenAI 兼容）',
  'apiConfig.providerZenMisc': '其他模型（opencode zen）',
  'apiConfig.chooseModel': '选择模型…',
  'apiConfig.model': '模型',
  'apiConfig.modelHint': '列表来自 opencode zen 模型目录；选“自定义（OpenAI 兼容）”可手动填任意模型 ID',
  'apiConfig.modelManualHint': '可填任意 OpenAI 兼容模型的 ID（如本地 ollama 的模型名）',
  'apiConfig.apiKey': 'API Key',
  'apiConfig.apiBaseUrl': 'API Base URL',
  'apiConfig.baseUrlHint': '切换提供商时若未手动修改，会自动填入该网关的默认地址',
  'apiConfig.modelsLoading': '正在加载模型目录…',
  'apiConfig.modelsLoadFailed': '模型目录加载失败，可手动填写模型 ID',
  'apiConfig.save': '保存设置',
  'apiConfig.saved': '已保存',
