...
export default function DocumentEditPage() {
  ...
  const guard = useUnsavedGuard({
    ...
    selectDraft: handleDraftSelect, deleteDraft: handleDraftDelete, deleteDrafts: handleDraftsDelete, setDirty,
  })
  ...
  // Submit for AI review：订阅 startReview（公开 action，docs/plugin.md §4）。
  ...
  // 同时把页面标题同步为与面包屑一致的文本（小程序原生导航栏 / H5 浏览器标签页）
